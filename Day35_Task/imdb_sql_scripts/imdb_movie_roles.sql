...
CREATE TABLE `movie_roles` (
  `mov_role_id` int NOT NULL AUTO_INCREMENT,
  `movie_id` int NOT NULL,
  `artist_id` int NOT NULL,
  `role` varchar(45) NOT NULL,
  PRIMARY KEY (`mov_role_id`)
...
LOCK TABLES `movie_roles` WRITE;
/*!40000 ALTER TABLE `movie_roles` DISABLE KEYS */;
/*!40000 ALTER TABLE `movie_roles` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-04-12 11:05:33
