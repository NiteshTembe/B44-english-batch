  ...
  return (
    <div className="container-fluid">
      ...
      <p className="mb-4">
        ...
        <a href="https://getbootstrap.com/docs" rel="noreferrer">
          ...
          <div className="card mb-4">
            ...
            <div className="card-body">
              ...
              <div className="progress mb-2">
                <div
                  className="progress-bar h-50 w-75"
                  role="progressbar"
                  aria-valuenow="75"
                  aria-valuemin="0"
                  aria-valuemax="100"
              ...
              Use the <code>.h-25</code> , <code>.h-50</code> or{" "}
              <code>.h-75</code> class along with <code>.progress-bar</code>
            </div>
          </div>
