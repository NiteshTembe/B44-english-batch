      ...
      <li className="nav-item">
        ...
        >
          <div className="bg-white py-2 collapse-inner rounded">
            ...
            <Link className="collapse-item" to="/utility-color">
              Colors
            </Link>
            <Link className="collapse-item" to="/utility-border">
              Borders
            </Link>
            <Link className="collapse-item" to="/utility-animation">
              Animations
            </Link>
            <Link className="collapse-item" to="/utility-other">
              Other
            </Link>
          </div>
        </div>
      ...
      <li className="nav-item">
        ...
        >
          <div className="bg-white py-2 collapse-inner rounded">
            ...
            <Link className="collapse-item" to="/page-404">
              404 Page
            </Link>
            <Link className="collapse-item" to="/page-blank">
              Blank Page
            </Link>
          </div>
        </div>
