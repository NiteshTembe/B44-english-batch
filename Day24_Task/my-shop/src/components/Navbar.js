            ...
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div className="d-flex">
                        <button className="btn btn-outline-dark" data-bs-toggle="offcanvas" data-bs-target="#shoppingCartCanvas" aria-controls="shoppingCartCanvas">
                            <i className="bi-cart-fill me-1"></i>
                            Cart
                            {cartItems.length ? <span className="badge bg-dark text-white ms-1 rounded-pill">{cartItems.length}</span> : "" }
                        </button>
                    </div>
                </div>
            </div>
