    ...
    <div className="container-custom mr-0 pr-0">
      ...
      <div className="row m-0">
              ...
              <div className="col-md-6">
                <form onSubmit={formik.handleSubmit}>
                  <div className="form-group mt-2">
                    <label for="email" className="label-style mb-0">Enter Registered Email</label>
                    <div>
                  ...
                  <Button type="submit" className="col-md-12 btn btn-lg btn-block login-btn mt-4 mb-4">Submit</Button>
                </form>
              </div>
            </div>
            </div>
        ...
        <div className="col-md-4 text-right pr-0">
          <img src="/media/login_img.cbed4040.png" className="img-class" alt=""/>
        </div>
      </div>
